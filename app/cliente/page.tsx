...
export default async function ClientePage() {
  ...
  return <ClientDashboard profile={profile} accountEmail={user.email||""} services={services||[]} professionals={professionals||[]} appointments={normalizedAppointments} membership={normalizedMembership}/>;
}
